  ...
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#1a1d2e;border:1px solid #2d3148;border-radius:16px;padding:20px;margin-bottom:24px;">
      ...
      ${goals.map((g: any) => {
        ...
        const progress = g.amount > 0 ? Math.min((savings / (g.amount / 12)) * 100, 100) : 0
        return `
    ...
    <p style="color:#4b5563;text-align:center;font-size:11px;margin-top:16px;">Unem AI · unem-ai.vercel.app</p>
  </div>
</body>
</html>
  `
